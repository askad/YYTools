...
public class CapTools {
    ...
    public CapTools(BufferedImage image) {
        this.image = image;
        iw = image.getWidth();
        ih = image.getHeight();
    ...
    public static void main(String[] args) throws Exception {
        ...
        CapTools ct = new CapTools(bi);
        ct.filterImg();
    }

    public void filterImg() throws Exception {
        BufferedImage bim = this.changeGrey();
//        ImageIO.write(bim, "jpg", new File("/temp/out_gray.jpg"));
        bim = this.grayFilter();
//        ImageIO.write(bim, "jpg", new File("/temp/out_gray_bg.jpg"));
        // bim = this.removeBackgroud();
        bim = this.oppoGray();
//        ImageIO.write(bim, "jpg", new File("/temp/out_gray_sp.jpg"));
        bim = this.doubleValue();
        ImageIO.write(bim, "jpg", new File("/temp/outp.jpg"));
    }

    /** 二值化*/
    public BufferedImage doubleValue() throws Exception {
